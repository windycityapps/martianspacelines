...
<?php
	echo '<div class="row">
	<p class="col-sm-12">
	You have chosen to spend <b>' . $dur . '</b> days on Mars.
	</p>
	</div>';
	echo '<div class="row">
	<p class="col-sm-12">' . marsTicket::marsEarthDistance() . ' days to Mars orbit.</p>
	</div>' ;
	echo '<div class="row">
	<p class="col-sm-12">' . $ticket->returnTrip() . ' return trip from Mars orbit to Earth orbit.</p>
	</div>' ;
